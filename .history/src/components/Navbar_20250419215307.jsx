    ...
    return (
                <div className=" z-10 flex flex-row bg-white dark:bg-gray-800 sticky top-0 left-0 right-0 h-20 items-center justify-between p-5">
                    ...
                    <div>
                        ...
                        <Link href='/service/cure' className="hover:text-[#117955] text-xl font-medium mx-3">Plant-Cure</Link>
                        <Link href='/service/weather' className="hover:text-[#117955] text-xl font-medium mx-3">Weather</Link>
