    ...
    return (
        <div className="flex flex-row bg-white dark:bg-gray-800 sticky top-0 left-0 right-0 h-20 items-center justify-between p-5">
            ...
            <div>
                ...
                <Link href='/auth/log-in' className="px-4 py-2 mx-1 text-xl  bg-white border-1 border-[#117955] text-[#117955] hover:text-white hover:bg-green-800 rounded-3xl">SignUp</Link>
            </div>
        </div>
    );
}
