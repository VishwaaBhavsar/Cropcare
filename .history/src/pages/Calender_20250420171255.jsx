...
const IndiaVegetableGrowingChart = () => {
  const vegetables = [
    ...
    },
    {
      name: "Onions",
      icon: "🧅",
      plantMonths: ["Oct", "Nov", "Dec", "Jan"],
      harvestMonths: ["Mar", "Apr", "May", "Jun"]
    },
    {
      name: "Cauliflower",
      icon: "🥦",
      plantMonths: ["Aug", "Sep", "Oct"],
      harvestMonths: ["Nov", "Dec", "Jan", "Feb"]
    },
    {
      name: "Spinach (Palak)",
      icon: "🍃",
      plantMonths: ["Sep", "Oct", "Feb", "Mar"],
      harvestMonths: ["Nov", "Dec", "Apr", "May"]
    },
    {
    ...
    },
    {
      name: "Green Chillies",
      icon: "🌶️",
      plantMonths: ["Jan", "Feb", "Jun", "Jul"],
      harvestMonths: ["Mar", "Apr", "Aug", "Sep"]
    },
    {
      name: "Radish (Mooli)",
      icon: "🥬",
      plantMonths: ["Aug", "Sep", "Oct", "Jan", "Feb"],
      harvestMonths: ["Oct", "Nov", "Dec", "Mar", "Apr"]
    },
    {
      name: "Coriander (Dhania)",
      icon: "🌿",
      plantMonths: ["Sep", "Oct", "Nov", "Feb", "Mar"],
      harvestMonths: ["Nov", "Dec", "Apr", "May"]
    },
    {
